...
public class OrderMain {
	...
	public OrderMain(int code, int customerCode, Timestamp dateTime, int payAmount, int usePoint, String payType,
			boolean takeOut) {
		this.code = code;
	...
	public OrderMain(Vector<String> values) {
		...
		this.usePoint = (int) DBController.parseData(values.get(4), "int");
