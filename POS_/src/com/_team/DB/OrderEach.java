...
public class OrderEach {
	...
	public OrderEach(int order_main_code, int product_code, int eachPrice, int eachNum, boolean size, boolean shot,
			boolean hotOrIce, boolean cream, boolean hazelSyrup, boolean almondSyrup, boolean vanillaSyrup) {
